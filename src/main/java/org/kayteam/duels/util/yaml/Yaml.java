...
package org.kayteam.duels.util.yaml;
...
import org.kayteam.duels.util.papi.PlaceholderAPIUtil;
...
public class Yaml {
    ...
    public void sendMessage(CommandSender commandSender, String path) {
        ...
        if (fileConfiguration.contains(path)) {
            ...
            javaPlugin.getLogger().info("Path '" + path + "' no found in the '" + name + ".yml' file");
            commandSender.sendMessage(ChatColor.translateAlternateColorCodes('&', "&cContact any admin."));
        }
    }
